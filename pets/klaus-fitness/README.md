...
同一位 Klaus，光膀子健身穿搭，强壮胸腹肌、运动短裤与训练鞋。
...
Install this folder as ~/.codex/pets/klaus-fitness, with pet.json and spritesheet.webp together. See the [installation guide](../../README.md#install-the-three-additional-outfits).
